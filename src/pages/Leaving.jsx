...
const Leaving = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      if (result.success) {
        // Sync Leaving Date and Reason back to JOINING sheet
        try {
          ...
          const updates = [
            { col: 41, val: formatDOB(formData.dateOfLeaving) }, // AO = 41
            { col: 42, val: formData.reasonOfLeaving }           // AP = 42
          ];
          ...
          console.error("Failed to sync to JOINING sheet:", e);
        }
